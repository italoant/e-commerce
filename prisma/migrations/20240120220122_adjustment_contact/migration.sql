...
INSERT INTO "new_Client" ("adress", "contact", "creatdAt", "external_user_id", "id", "status", "updatedAt", "userFullName") SELECT "adress", "contact", "creatdAt", "external_user_id", "id", "status", "updatedAt", "userFullName" FROM "Client";
DROP TABLE "Client";
